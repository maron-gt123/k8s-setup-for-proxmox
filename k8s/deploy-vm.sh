...
VM_LIST=(
    ...
    "881 onp-k8s-wk-1 6    24576 192.168.15.84 192.168.6.84 192.168.6.141 onp-prox01-SV"
    "882 onp-k8s-wk-2 6    24576 192.168.15.85 192.168.6.85 192.168.6.142 onp-prox02-SV"
    "883 onp-k8s-wk-3 6    24576 192.168.15.86 192.168.6.86 192.168.6.143 onp-prox03-SV"
)
#endregion
